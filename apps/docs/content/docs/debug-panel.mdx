...
`update` is idempotent — existing wiring (mount, plugin registration, log permission) is preserved. See [Manage batteries](/docs/manage-batteries) for the full workflow.
