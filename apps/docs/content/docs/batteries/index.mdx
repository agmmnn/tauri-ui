...
<Cards>
  <Card title="Debug panel" href="/docs/batteries/debug-panel">
    Development-only desktop inspector for runtime state, logs, invokes, and paths.
  </Card>
  <Card title="Size optimization" href="/docs/batteries/size-optimization">
    Smaller release binaries through Tauri release-profile tuning.
  </Card>
  <Card title="Release workflow" href="/docs/batteries/release-workflow">
